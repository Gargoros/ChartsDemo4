...
struct SectorChartHorizontalView: View {
    //MARK: - Variables
    ...
    var body: some View {
        ...
        .chartLegend(position: .trailing, alignment: .leading, spacing: 10)
        
    }
}

#Preview {
    SectorChartHorizontalView(chartItem: .constant(ChartItem.defaultChartItem))
}
